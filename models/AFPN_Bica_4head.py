...
class ASFF_bica4_2(nn.Module):
    def __init__(self, inter_dim=512, level=0, channel=[64, 128]):
        super(ASFF_bica4_2, self).__init__()
        ...
        self.cord2 = CoordAtt(self.inter_dim * 2, self.inter_dim * 2)
    ...
    def forward(self, x):
        ...
        fused_out_reduced = self.cord2(feats)
        ...
        # levels_weight_v = self.bincat2([level_1_weight_v, level_2_weight_v])
...
class ASFF_bica4_3(nn.Module):
    def __init__(self, inter_dim=512, level=0, channel=[64, 128, 256]):
        super(ASFF_bica4_3, self).__init__()
        ...
        self.cord3 = CoordAtt(self.inter_dim * 3, self.inter_dim * 3)
    ...
    def forward(self, x):
        ...
        fused_out_reduced = self.cord3(feats)
        out = self.conv_sample(fused_out_reduced)
...
class ASFF_bica4_4(nn.Module):
    ...
    def forward(self, x):
        ...
        fused_out_reduced = self.cord4(feats)
        out = self.conv_sample(fused_out_reduced)
