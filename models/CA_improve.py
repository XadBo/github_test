...
class ASFF_CAimprove_2(nn.Module):
    def __init__(self, inter_dim=512, level=0, channel=[64, 128]):
        super(ASFF_CAimprove_2, self).__init__()
...
class ASFF_CAimprove_3(nn.Module):
    def __init__(self, inter_dim=512, level=0, channel=[64, 128, 256]):
        super(ASFF_CAimprove_3, self).__init__()
...
class ASFF_CAimprove_4(nn.Module):
    def __init__(self, inter_dim=512, level=0, channel=[32, 64, 128, 256]):
        super(ASFF_CAimprove_4, self).__init__()
