...
def run(
    ...
    if not training:
        ...
        #FPS = 1000 / sum(t)
        #LOGGER.info(f'FPS: {round(FPS, 3)}') # add by bo to find FPS
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path('G:/VisDrone2019/Coco_VisDrone/annotations/VisDrone2019-DET_val_coco_start.json'))  # annotations
