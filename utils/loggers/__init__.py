...
class Loggers():
    ...
    def on_val_end(self, nt, tp, fp, p, r, f1, ap, ap75, ap50, ap_class, confusion_matrix):
        ...
        if self.comet_logger:
            self.comet_logger.on_val_end(nt, tp, fp, p, r, f1, ap, ap75, ap50, ap_class, confusion_matrix)
